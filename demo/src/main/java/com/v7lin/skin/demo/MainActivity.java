...
import com.v7lin.android.support.env.SkinData;
import com.v7lin.android.support.env.SkinExtraCreator;
...
public class MainActivity extends SupportActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SkinExtraCreator skinExtraCreator = new SkinExtraCreator(getEnvResBridge());
        ...
        findViewById(R.id.change_color).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                changeSkin.setBackgroundResource(i++ % 2 == 1 ? com.v7lin.skin.R.color.primary : com.v7lin.skin.R.color.primary_dark);
            }
        });
    }
}
