...
public class CompatEditText extends EditText implements XTextViewCall, EnvCallback<TextView, XTextViewCall> {
	...
	public CompatEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
