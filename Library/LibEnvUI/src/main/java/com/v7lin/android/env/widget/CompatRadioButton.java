...
public class CompatRadioButton extends RadioButton implements XCompoundButtonCall, EnvCallback<CompoundButton, XCompoundButtonCall> {
	...
	public CompatRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatRadioButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
