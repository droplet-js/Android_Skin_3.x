...
public class CompatGridView extends GridView implements XAbsListViewCall, EnvCallback<AbsListView, XAbsListViewCall> {
	...
	public CompatGridView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatGridView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	@Override
	public EnvUIChanger<AbsListView, XAbsListViewCall> ensureEnvUIChanger(EnvResBridge bridge, boolean allowSysRes) {
		if (mEnvUIChanger == null) {
			mEnvUIChanger = new EnvAbsListViewChanger<AbsListView, XAbsListViewCall>(getContext(), bridge, allowSysRes);
		}
