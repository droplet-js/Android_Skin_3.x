...
public class CompatTimePicker extends TimePicker implements XFrameLayoutCall, EnvCallback<FrameLayout, XFrameLayoutCall> {
	...
	public CompatTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatTimePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
