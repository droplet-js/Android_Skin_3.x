...
public class CompatToggleButton extends ToggleButton implements XCompoundButtonCall, EnvCallback<CompoundButton, XCompoundButtonCall> {
	...
	public CompatToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatToggleButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
