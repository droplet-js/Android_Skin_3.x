...
public class CompatCheckedTextView extends CheckedTextView implements XCheckedTextViewCall, EnvCallback<CheckedTextView, XCheckedTextViewCall> {
	...
	public CompatCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	private void applyAttrCheckMarkDrawable(int resid) {
		applyAttr(android.R.attr.checkMark, resid);
	}
	...
	@Override
	public EnvUIChanger<CheckedTextView, XCheckedTextViewCall> ensureEnvUIChanger(EnvResBridge bridge, boolean allowSysRes) {
		if (mEnvUIChanger == null) {
			mEnvUIChanger = new EnvCheckedTextViewChanger<CheckedTextView, XCheckedTextViewCall>(getContext(), bridge, allowSysRes);
		}
