...
public class CompatAutoCompleteTextView extends AutoCompleteTextView implements XTextViewCall, EnvCallback<TextView, XTextViewCall> {
	...
	public CompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
