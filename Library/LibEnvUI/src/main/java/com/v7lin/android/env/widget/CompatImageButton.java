...
public class CompatImageButton extends ImageButton implements XImageViewCall, EnvCallback<ImageView, XImageViewCall> {
	...
	public CompatImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatImageButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
