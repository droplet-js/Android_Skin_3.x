...
public class CompatChronometer extends Chronometer implements XTextViewCall, EnvCallback<TextView, XTextViewCall> {
	...
	public CompatChronometer(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatChronometer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
