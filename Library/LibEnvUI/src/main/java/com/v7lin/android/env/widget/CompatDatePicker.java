...
public class CompatDatePicker extends DatePicker implements XFrameLayoutCall, EnvCallback<FrameLayout, XFrameLayoutCall> {
	...
	public CompatDatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatDatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
