...
public class CompatLinearLayout extends LinearLayout implements XViewGroupCall, EnvCallback<ViewGroup, XViewGroupCall> {
	...
	public CompatLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
