...
public class CompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements XTextViewCall, EnvCallback<TextView, XTextViewCall> {

    private EnvUIChanger<TextView, XTextViewCall> mEnvUIChanger;

    public CompatMultiAutoCompleteTextView(Context context) {
        super(context);
    }

    public CompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    @Override
    public EnvUIChanger<TextView, XTextViewCall> ensureEnvUIChanger(EnvResBridge bridge, boolean allowSysRes) {
        if (mEnvUIChanger == null) {
            mEnvUIChanger = new EnvTextViewChanger<TextView, XTextViewCall>(getContext(), bridge, allowSysRes);
        }
