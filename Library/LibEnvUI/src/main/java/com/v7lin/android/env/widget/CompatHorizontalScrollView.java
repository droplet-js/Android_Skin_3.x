...
public class CompatHorizontalScrollView extends HorizontalScrollView implements XFrameLayoutCall, EnvCallback<FrameLayout, XFrameLayoutCall> {
	...
	public CompatHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public CompatHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
	...
	private void applyAttrForeground(int resid) {
		applyAttr(android.R.attr.foreground, resid);
	}
	...
	@Override
	public EnvUIChanger<FrameLayout, XFrameLayoutCall> ensureEnvUIChanger(EnvResBridge bridge, boolean allowSysRes) {
		if (mEnvUIChanger == null) {
			mEnvUIChanger = new EnvFrameLayoutChanger<FrameLayout, XFrameLayoutCall>(getContext(), bridge, allowSysRes);
		}
